...
public class PlayerHandshakeEvent extends Event implements Cancellable {
    ...
    private Component failMessage = Component.text("如果你希望使用 IP 转发，请同时在你的 BungeeCord 配置中启用它！", NamedTextColor.YELLOW);
    ...
    public void setFailMessage(final String failMessage) {
        Preconditions.checkArgument(failMessage != null && !failMessage.isEmpty(), "失败消息不能为 null 或空");
