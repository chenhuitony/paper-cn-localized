    ...
    public static final class QueryResponse {
        ...
        public static final class Builder {
            ...
            public Builder currentPlayers(final int currentPlayers) {
                Preconditions.checkArgument(currentPlayers >= 0, "currentPlayers 不能为负数");
                this.currentPlayers = currentPlayers;
                return this;
            }

            public Builder maxPlayers(final int maxPlayers) {
                Preconditions.checkArgument(maxPlayers >= 0, "maxPlayers 不能为负数");
                this.maxPlayers = maxPlayers;
                return this;
            }
            ...
            public Builder port(final int port) {
                Preconditions.checkArgument(port >= 1 && port <= 65535, "端口必须在 1-65535 之间");
                this.port = port;
                return this;
            }
