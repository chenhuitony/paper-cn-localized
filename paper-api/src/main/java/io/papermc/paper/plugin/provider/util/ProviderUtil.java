        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    throw new ClassCastException("类 '%s' 不继承自 '%s'".formatted(clazz, classType));
                }
                ...
                try {
                    ...
                    throw new RuntimeException("构造函数不可访问");
                }

                clazzInstance = constructor.newInstance();
            } catch (final IllegalAccessException exception) {
                throw new RuntimeException("没有 public 构造函数");
            } catch (final InstantiationException exception) {
                throw new RuntimeException("异常的类实例化", exception);
            }
