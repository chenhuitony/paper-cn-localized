...
public final class MapCursor {
    ...
    public void setDirection(byte direction) {
        Preconditions.checkArgument(direction >= 0 && direction <= 15, "direction 必须在 0 到 15 之间，但实际为 %s", direction);
    ...
    public void setRawType(byte type) {
        ...
        Preconditions.checkArgument(enumType != null, "未知的 ID 对应类型 %s", type);
        this.type = enumType;
    }
    ...
    public interface Type extends OldEnum<Type>, Keyed {
        ...
        static Type valueOf(@NotNull String name) {
            ...
            Preconditions.checkArgument(type != null, "未找到名为 %s 的类型", name);
            return type;
        }
