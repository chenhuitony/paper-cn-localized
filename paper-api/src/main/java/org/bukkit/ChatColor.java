...
public enum ChatColor {
    ...
    public static ChatColor getByChar(@NotNull String code) {
        Preconditions.checkArgument(code != null, "代码不能为 null");
        Preconditions.checkArgument(code.length() > 0, "代码至少必须包含一个字符");
    ...
    public static String translateAlternateColorCodes(char altColorChar, @NotNull String textToTranslate) {
        Preconditions.checkArgument(textToTranslate != null, "无法翻译 null 文本");
    ...
    public static String getLastColors(@NotNull String input) {
        Preconditions.checkArgument(input != null, "无法从 null 文本获取末尾颜色");
