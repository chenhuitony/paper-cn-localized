...
public class Transformation {
    ...
    public Transformation(@NotNull Vector3f translation, @NotNull AxisAngle4f leftRotation, @NotNull Vector3f scale, @NotNull AxisAngle4f rightRotation) {
        Preconditions.checkArgument(translation != null, "translation 不能为 null");
        Preconditions.checkArgument(leftRotation != null, "leftRotation 不能为 null");
        Preconditions.checkArgument(scale != null, "scale 不能为 null");
        Preconditions.checkArgument(rightRotation != null, "rightRotation 不能为 null");
