...
public class BoundingBox implements Cloneable, ConfigurationSerializable {
    ...
    public static BoundingBox of(@NotNull Vector corner1, @NotNull Vector corner2) {
        Preconditions.checkArgument(corner1 != null, "Corner1 为 null！");
        Preconditions.checkArgument(corner2 != null, "Corner2 为 null！");
    ...
    public static BoundingBox of(@NotNull Location corner1, @NotNull Location corner2) {
        Preconditions.checkArgument(corner1 != null, "Corner1 为 null！");
        Preconditions.checkArgument(corner2 != null, "Corner2 为 null！");
        Preconditions.checkArgument(Objects.equals(corner1.getWorld(), corner2.getWorld()), "位置来自不同的世界！");
        return new BoundingBox(corner1.getX(), corner1.getY(), corner1.getZ(), corner2.getX(), corner2.getY(), corner2.getZ());
    }
    ...
    public static BoundingBox of(@NotNull Block corner1, @NotNull Block corner2) {
        Preconditions.checkArgument(corner1 != null, "Corner1 为 null！");
        Preconditions.checkArgument(corner2 != null, "Corner2 为 null！");
        Preconditions.checkArgument(Objects.equals(corner1.getWorld(), corner2.getWorld()), "方块来自不同的世界！");
    ...
    public static BoundingBox of(@NotNull Block block) {
        Preconditions.checkArgument(block != null, "方块为 null！");
    ...
    public static BoundingBox of(@NotNull Vector center, double x, double y, double z) {
        Preconditions.checkArgument(center != null, "中心点为 null！");
    ...
    public BoundingBox resize(double x1, double y1, double z1, double x2, double y2, double z2) {
        NumberConversions.checkFinite(x1, "x1 不是有限数");
        NumberConversions.checkFinite(y1, "y1 不是有限数");
        NumberConversions.checkFinite(z1, "z1 不是有限数");
        NumberConversions.checkFinite(x2, "x2 不是有限数");
        NumberConversions.checkFinite(y2, "y2 不是有限数");
        NumberConversions.checkFinite(z2, "z2 不是有限数");
    ...
    public BoundingBox copy(@NotNull BoundingBox other) {
        Preconditions.checkArgument(other != null, "另一个边界框为 null！");
    ...
    public BoundingBox expand(@NotNull Vector expansion) {
        Preconditions.checkArgument(expansion != null, "Expansion 为 null！");
    ...
    public BoundingBox expand(@NotNull Vector direction, double expansion) {
        Preconditions.checkArgument(direction != null, "方向为 null！");
    ...
    public BoundingBox expand(@NotNull BlockFace blockFace, double expansion) {
        Preconditions.checkArgument(blockFace != null, "方块面为 null！");
    ...
    public BoundingBox expandDirectional(@NotNull Vector direction) {
        Preconditions.checkArgument(direction != null, "Expansion 为 null！");
    ...
    public BoundingBox union(@NotNull Vector position) {
        Preconditions.checkArgument(position != null, "位置为 null！");
    ...
    public BoundingBox intersection(@NotNull BoundingBox other) {
        Preconditions.checkArgument(other != null, "另一个边界框为 null！");
        Preconditions.checkArgument(this.overlaps(other), "边界框不重叠！");
    ...
    public BoundingBox shift(@NotNull Vector shift) {
        Preconditions.checkArgument(shift != null, "Shift 为 null！");
    ...
    public boolean overlaps(@NotNull Vector min, @NotNull Vector max) {
        Preconditions.checkArgument(min != null, "Min 为 null！");
        Preconditions.checkArgument(max != null, "Max 为 null！");
        double x1 = min.getX();
        double y1 = min.getY();
        double z1 = min.getZ();
        double x2 = max.getX();
    ...
    public RayTraceResult rayTrace(@NotNull Vector start, @NotNull Vector direction, double maxDistance) {
        Preconditions.checkArgument(start != null, "Start 为 null！");
        start.checkFinite();
        Preconditions.checkArgument(direction != null, "方向为 null！");
        direction.checkFinite();
        Preconditions.checkArgument(direction.lengthSquared() > 0, "方向大小为 0！");
