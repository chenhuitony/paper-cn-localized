...
public class EnchantmentOffer {
    ...
    public void setEnchantment(@NotNull Enchantment enchantment) {
        Preconditions.checkArgument(enchantment != null, "附魔不能为 null！");
    ...
    public void setEnchantmentLevel(int enchantmentLevel) {
        Preconditions.checkArgument(enchantmentLevel > 0, "附魔等级必须大于 0！");
    ...
    public void setCost(int cost) {
        Preconditions.checkArgument(cost > 0, "花费必须大于 0！");
