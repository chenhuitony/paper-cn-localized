...
record PredicateRecipeChoiceImpl(Predicate<? super ItemStack> stackPredicate, ItemStack exampleStack) implements RecipeChoice.PredicateChoice {
    ...
    public PredicateRecipeChoiceImpl {
        Preconditions.checkArgument(stackPredicate != null, "物品断言不能为 null");
        Preconditions.checkArgument(exampleStack != null, "示例物品堆不能为 null");
        Preconditions.checkArgument(!exampleStack.isEmpty(), "示例物品堆不能为空/空气");
