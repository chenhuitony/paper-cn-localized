...
public class Mushroom extends MaterialData {
    ...
    public Mushroom(Material shroom) {
        super(shroom);
        Preconditions.checkArgument(shroom == Material.LEGACY_HUGE_MUSHROOM_1 || shroom == Material.LEGACY_HUGE_MUSHROOM_2, "不是蘑菇！");
    }
    ...
    public void setFacePainted(BlockFace face, boolean painted) {
        ...
        switch (face) {
            ...
            case DOWN:
                ...
                break;
            default:
                throw new IllegalArgumentException("无法在蘑菇的那个面上涂色！");
        }
