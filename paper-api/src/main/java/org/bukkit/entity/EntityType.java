...
public enum EntityType implements Keyed, Translatable, net.kyori.adventure.translation.Translatable, io.papermc.paper.world.flag.FeatureDependant { // Paper - translatable
    ...
    public NamespacedKey getKey() {
        Preconditions.checkArgument(key != null, "EntityType 没有键！它是 UNKNOWN 吗？");
    ...
    public @NotNull String translationKey() {
        Preconditions.checkArgument(this != UNKNOWN, "UNKNOWN 实体没有翻译键");
    ...
    public @NotNull SpawnCategory getSpawnCategory() {
        Preconditions.checkArgument(this != UNKNOWN, "UNKNOWN 实体没有生成类别");
    ...
    public @NotNull org.bukkit.attribute.Attributable getDefaultAttributes() {
        Preconditions.checkArgument(this.hasDefaultAttributes(), this.key + " 没有默认属性");
