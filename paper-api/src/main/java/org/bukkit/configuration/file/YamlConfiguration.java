...
public class YamlConfiguration extends FileConfiguration {
    ...
    public void loadFromString(@NotNull String contents) throws InvalidConfigurationException {
        Preconditions.checkArgument(contents != null, "内容不能为 null");
        ...
        try (Reader reader = new UnicodeReader(new ByteArrayInputStream(contents.getBytes(StandardCharsets.UTF_8)))) {
            ...
            try {
                ...
                throw new InvalidConfigurationException("顶层不是一个 Map。");
            }
    ...
    public static YamlConfiguration loadConfiguration(@NotNull File file) {
        ...
        try {
            ...
            Bukkit.getLogger().log(Level.SEVERE, "无法加载 " + file, ex);
    ...
    public static YamlConfiguration loadConfiguration(@NotNull Reader reader) {
        Preconditions.checkArgument(reader != null, "流不能为 null");
        ...
        try {
            ...
            Bukkit.getLogger().log(Level.SEVERE, "无法从流加载配置", ex);
        } catch (InvalidConfigurationException ex) {
            Bukkit.getLogger().log(Level.SEVERE, "无法从流加载配置", ex);
        }
