...
public class Location implements Cloneable, ConfigurationSerializable, io.papermc.paper.math.FinePosition {
    ...
    public World getWorld() {
        ...
        World world = this.world.get();
        Preconditions.checkArgument(world != null, "世界已卸载");
        return world;
    }
    ...
    public Location add(@NotNull Location vec) {
        if (vec == null || vec.getWorld() != getWorld()) {
            throw new IllegalArgumentException("无法添加来自不同世界的 Location");
        }
    ...
    public double distanceSquared(@NotNull Location o) {
        if (o == null) {
            throw new IllegalArgumentException("无法测量到 null 位置的距离");
        } else if (o.getWorld() == null || getWorld() == null) {
            throw new IllegalArgumentException("无法测量到 null 世界的距离");
        } else if (o.getWorld() != getWorld()) {
            throw new IllegalArgumentException("无法测量以下两者之间的距离：" + getWorld().key().asString() + " and " + o.getWorld().key().asString());
        }
    ...
    public boolean isGenerated() {
        ...
        Preconditions.checkNotNull(world, "位置没有关联世界！");
    ...
    public @NotNull Collection<Entity> getNearbyEntities(final double x, final double y, final double z) {
        ...
        if (world == null) {
            throw new IllegalArgumentException("位置没有关联世界");
        }
    ...
    public void checkFinite() throws IllegalArgumentException {
        NumberConversions.checkFinite(x, "x 不是有限数");
        NumberConversions.checkFinite(y, "y 不是有限数");
        NumberConversions.checkFinite(z, "z 不是有限数");
    ...
    public static Location deserialize(@NotNull Map<String, Object> args) {
        ...
        if (requiresWorld && world == null) {
            throw new IllegalArgumentException("未知世界");
        }
