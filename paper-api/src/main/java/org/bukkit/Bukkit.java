...
public final class Bukkit {
    ...
    public static void setServer(@NotNull Server server) {
        if (Bukkit.server != null) {
            throw new UnsupportedOperationException("无法重定义单例 Server");
        }
    ...
    public static String getVersionMessage() {
        ...
        return "本服务端正在运行 " + getName() + " version " + version.asString(io.papermc.paper.ServerBuildInfo.StringRepresentation.VERSION_FULL) + "（实现 API 版本 " + getBukkitVersion() + ")";
        // Paper end
    }
