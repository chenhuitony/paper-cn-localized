...
public final class PluginDescriptionFile implements io.papermc.paper.plugin.configuration.PluginMeta { // Paper
    ...
    public PluginDescriptionFile(@NotNull final String pluginName, @NotNull final String pluginVersion, @NotNull final String mainClass) {
        ...
        if (!VALID_NAME.matcher(name).matches()) {
            throw new IllegalArgumentException("名称 '" + name + "' 包含非法字符。");
        }
        name = name.replace(' ', '_');
    ...
    public List<Permission> getPermissions() {
        if (permissions == null) {
            if (lazyPermissions == null) {
                ...
                permissions = ImmutableList.copyOf(Permission.loadPermissions(lazyPermissions, "插件描述文件中的权限节点 '%s'（属于 " + getFullName() + " 无效", defaultPerm));
    ...
    private void loadMap(@NotNull Map<?, ?> map) throws InvalidDescriptionException {
        try {
            ...
            if (!VALID_NAME.matcher(name).matches()) {
                throw new InvalidDescriptionException("名称 '" + name + "' 包含非法字符。");
            }
            name = name.replace(' ', '_');
        } catch (NullPointerException ex) {
            throw new InvalidDescriptionException(ex, "name 未定义");
        } catch (ClassCastException ex) {
            throw new InvalidDescriptionException(ex, "name 类型错误");
        }
        ...
        try {
            ...
            throw new InvalidDescriptionException(ex, "未定义 version");
        } catch (ClassCastException ex) {
            throw new InvalidDescriptionException(ex, "version 的类型不正确");
        }

        try {
            main = map.get("main").toString();
            if (main.startsWith("org.bukkit.")) {
                throw new InvalidDescriptionException("main 不能位于 org.bukkit 命名空间内");
            }
        } catch (NullPointerException ex) {
            throw new InvalidDescriptionException(ex, "main 未定义");
        } catch (ClassCastException ex) {
            throw new InvalidDescriptionException(ex, "main 类型错误");
        }
        ...
        if (map.get("commands") != null) {
            ...
            try {
                ...
                throw new InvalidDescriptionException(ex, "commands 类型错误");
            }
        ...
        if (map.get("load") != null) {
            try {
                ...
                throw new InvalidDescriptionException(ex, "load 类型错误");
            } catch (IllegalArgumentException ex) {
                throw new InvalidDescriptionException(ex, "load 不是有效选项");
            }
        }
        ...
        if (map.get("authors") != null) {
            ...
            try {
                ...
                throw new InvalidDescriptionException(ex, "authors 类型错误");
            } catch (NullPointerException ex) {
                throw new InvalidDescriptionException(ex, "authors 定义不正确");
            }
        ...
        if (map.get("contributors") != null) {
            ...
            try {
                ...
                throw new InvalidDescriptionException(ex, "contributors 类型错误");
            }
        ...
        if (map.get("default-permission") != null) {
            try {
                ...
                throw new InvalidDescriptionException(ex, "default-permission 类型错误");
            } catch (IllegalArgumentException ex) {
                throw new InvalidDescriptionException(ex, "default-permission 不是有效选项");
            }
        }
        ...
        if (map.get("awareness") instanceof Iterable) {
            ...
            try {
                ...
                throw new InvalidDescriptionException(ex, "awareness 类型错误");
            }
        ...
        if (map.get("libraries") != null) {
            ...
            try {
                ...
                throw new InvalidDescriptionException(ex, "libraries 类型错误");
            }
        ...
        */
        ...
        try {
            ...
            throw new InvalidDescriptionException(ex, "权限的类型不正确");
        }
    ...
    private static List<String> makePluginNameList(@NotNull final Map<?, ?> map, @NotNull final String key) throws InvalidDescriptionException {
        ...
        try {
            ...
            throw new InvalidDescriptionException(ex, key + " 类型错误");
        } catch (NullPointerException ex) {
    ...
    private Map<?, ?> asMap(@NotNull Object object) throws InvalidDescriptionException {
        ...
        throw new InvalidDescriptionException("插件描述文件为空或结构不正确。它是 " + object + "，但应为 map。");
    }
