...
public enum Material implements Keyed, Translatable, net.kyori.adventure.translation.Translatable { // Paper
    ...
    public boolean isCollidable() {
        ...
        throw new IllegalArgumentException(this + " 不是方块类型");
    }
    ...
    public int getId() {
        Preconditions.checkArgument(legacy, "无法获取现代物品类型的 ID");
        return id;
    }
    ...
    public NamespacedKey getKey() {
        Preconditions.checkArgument(!legacy, "无法获取旧版物品类型的键");
        return key;
    }
    ...
    public Class<? extends MaterialData> getData() {
        Preconditions.checkArgument(legacy, "无法获取现代物品类型的数据类");
    ...
    public MaterialData getNewData(final byte raw) {
        Preconditions.checkArgument(legacy, "无法获取现代物品类型的新数据");
        try {
    ...
    public float getHardness() {
        BlockType type = asBlockType();
        Preconditions.checkArgument(type != null, "该材料不是方块！");
    ...
    public Material getCraftingRemainingItem() {
        ItemType type = asItemType();
        Preconditions.checkArgument(type != null, "该材料不是物品！");
