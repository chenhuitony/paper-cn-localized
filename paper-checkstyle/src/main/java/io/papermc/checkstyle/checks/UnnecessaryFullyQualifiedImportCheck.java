    ...
    public void visitToken(final DetailAST ast) {
        ...
        do {
            ...
            if (this.hasImportFor(typeName)) {
                this.log(startNode.getLineNo(), startNode.getColumnNo(), "使用了全限定导入：" + fullIdentName);
                return;
            }
        ...
        if (fullImportBySimple == null) {
            this.log(startNode.getLineNo(), startNode.getColumnNo(), "不必要的全限定导入（无冲突）：" + fullIdentName);
        }
    }
}
