...
public class CraftVillager extends CraftAbstractVillager implements Villager {
    ...
    public void setProfession(Profession profession) {
        Preconditions.checkArgument(profession != null, "职业不能为 null");
    ...
    public void setVillagerExperience(int experience) {
        Preconditions.checkArgument(experience >= 0, "经验值 (%s) 必须为正数", experience);
    ...
    public boolean increaseLevel(int amount) {
        Preconditions.checkArgument(amount > 0, "获得的经验等级必须为正数");
    ...
    public boolean addTrades(int amount) {
        Preconditions.checkArgument(amount > 0, "已解锁交易次数必须为正数");
    ...
    public boolean sleep(Location location) {
        ...
        Preconditions.checkState(!this.getHandle().generation, "世界生成期间无法睡觉");
    ...
    public void wakeup() {
        ...
        Preconditions.checkState(!this.getHandle().generation, "世界生成期间无法醒来");
