...
public abstract class CraftMob extends CraftLivingEntity implements Mob, io.papermc.paper.entity.PaperLeashable { // Paper - Leashable API
    ...
    public void setTarget(LivingEntity target) {
        Preconditions.checkState(!this.getHandle().generation, "世界生成期间无法设置目标");
    ...
    public void lookAt(@org.jetbrains.annotations.NotNull org.bukkit.Location location) {
        com.google.common.base.Preconditions.checkNotNull(location, "location 不能为 null");
        com.google.common.base.Preconditions.checkArgument(location.getWorld().equals(getWorld()), "位置位于不同的世界");
    ...
    public void lookAt(@org.jetbrains.annotations.NotNull org.bukkit.entity.Entity entity) {
        com.google.common.base.Preconditions.checkNotNull(entity, "entity 不能为 null");
        com.google.common.base.Preconditions.checkArgument(entity.getWorld().equals(getWorld()), "实体位于不同的世界");
