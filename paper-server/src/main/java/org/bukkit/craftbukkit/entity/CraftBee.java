...
public class CraftBee extends CraftAnimals implements Bee {
    ...
    public void setHive(Location location) {
        Preconditions.checkArgument(location == null || this.getWorld().equals(location.getWorld()), "蜂箱必须位于同一世界");
    ...
    public void setFlower(Location location) {
        Preconditions.checkArgument(location == null || this.getWorld().equals(location.getWorld()), "花必须位于同一世界");
    ...
    public void setTimeSinceSting(int time) {
        Preconditions.checkArgument(time >= 0, "距被蛰时间不能为负");
