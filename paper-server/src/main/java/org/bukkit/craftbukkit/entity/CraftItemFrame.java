...
public class CraftItemFrame extends CraftHanging implements ItemFrame {
    ...
    public boolean setFacingDirection(BlockFace face, boolean force) {
        ...
        Preconditions.checkArgument(newDir != null, "%s 不是合法的朝向", face);
    ...
    public void setItemDropChance(float chance) {
        Preconditions.checkArgument(0.0 <= chance && chance <= 1.0, "几率 (%s) 超出范围 [0, 1]", chance);
    ...
    Rotation toBukkitRotation(int value) {
        ...
        default:
            throw new AssertionError("未知的旋转 " + value + " for " + this.getHandle());
        }
    }

    @Override
    public void setRotation(Rotation rotation) {
        Preconditions.checkArgument(rotation != null, "旋转不能为 null");
    ...
    static int toInteger(Rotation rotation) {
        ...
        case COUNTER_CLOCKWISE_45:
            return 7;
        default:
            throw new IllegalArgumentException(rotation + " 不适用于物品展示框");
        }
    }
