...
public class CraftDisplay extends CraftEntity implements Display {
    ...
    public void setTransformation(Transformation transformation) {
        Preconditions.checkArgument(transformation != null, "Transformation 不能为 null");
    ...
    public void setTransformationMatrix(org.joml.Matrix4f transformationMatrix) {
        Preconditions.checkArgument(transformationMatrix != null, "变换矩阵不能为 null");
    ...
    public void setTeleportDuration(int duration) {
        Preconditions.checkArgument(duration >= 0 && duration <= 59, "持续时间（%s）不能小于 0 或大于 59", duration);
    ...
    public void setBillboard(Billboard billboard) {
        Preconditions.checkArgument(billboard != null, "Billboard 不能为 null");
