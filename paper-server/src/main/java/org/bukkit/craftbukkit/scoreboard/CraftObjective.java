...
final class CraftObjective extends CraftScoreboardComponent implements Objective {
    ...
    public Score getScore(String entry) {
        ...
        Preconditions.checkArgument(entry.length() <= Short.MAX_VALUE, "分数 '" + entry + "' 超过了 32767 个字符的限制");
        this.checkState();
    ...
    @Override
    void checkState() {
        Preconditions.checkState(this.getScoreboard().getHandle().getObjective(this.objective.getName()) != null, "未注册的记分板组件");
    }
