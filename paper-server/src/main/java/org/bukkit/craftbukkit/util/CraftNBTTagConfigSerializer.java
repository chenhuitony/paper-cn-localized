    ...
    public static Tag deserialize(final Object object) {
        ...
        if (object instanceof final String snbtString) {
            try {
                ...
                throw new RuntimeException("反序列化 nbt 失败", e);
            }
        ...
        if (object instanceof Map) {
            ...
            if (CraftNBTTagConfigSerializer.ARRAY.matcher(string).matches()) {
                try {
                    ...
                    throw new RuntimeException("无法反序列化找到的列表 ", e);
                }
                ...
                try {
                    ...
                    throw new RuntimeException("无法反序列化找到的基本类型 ", commandSyntaxException);
                }
            }
        }

        throw new RuntimeException("无法反序列化 Tag");
    }
}
