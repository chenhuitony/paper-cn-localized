...
public class CraftTrialSpawnerConfiguration implements TrialSpawnerConfiguration {
    ...
    public void setDelay(int delay) {
        Preconditions.checkArgument(delay >= 0, "延迟不能小于 0");
    ...
    public void addPossibleReward(LootTable table, int weight) {
        Preconditions.checkArgument(table != null, "表不能为 null");
        Preconditions.checkArgument(weight >= 1, "权重必须至少为 1");
    ...
    public void removePossibleReward(LootTable table) {
        Preconditions.checkArgument(table != null, "键不能为 null");
