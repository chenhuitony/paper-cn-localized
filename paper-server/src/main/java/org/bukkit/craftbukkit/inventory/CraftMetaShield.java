...
public class CraftMetaShield extends CraftMetaItem implements ShieldMeta, BlockStateMeta {
    ...
    CraftMetaShield(Map<String, Object> map) {
        ...
        for (Object obj : rawPatternList) {
            Preconditions.checkArgument(obj instanceof Pattern, "图案列表中的对象（%s）无效", obj.getClass());
    ...
    public void setBlockState(BlockState blockState) {
        Preconditions.checkArgument(blockState != null, "blockState 不能为 null");
        Preconditions.checkArgument(blockState instanceof Banner, "blockState 无效");
