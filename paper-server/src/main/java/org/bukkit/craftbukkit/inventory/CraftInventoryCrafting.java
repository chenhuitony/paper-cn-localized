...
public class CraftInventoryCrafting extends CraftInventory implements CraftingInventory {
    ...
    public void setMatrix(ItemStack[] contents) {
        Preconditions.checkArgument(contents.length <= this.getMatrixInventory().getContainerSize(), "物品栏大小无效（%s）；期望为 %s 或更小", contents.length, this.getMatrixInventory().getContainerSize());
