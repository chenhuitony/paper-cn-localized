...
public class CraftMetaBookSigned extends CraftMetaItem implements BookMeta {
    ...
    public String getPage(final int page) {
        Preconditions.checkArgument(this.isValidPage(page), "页码无效（%s）", page);
        // assert: pages != null
    ...
    public void setPage(final int page, final String text) {
        Preconditions.checkArgument(this.isValidPage(page), "页码无效（%s/%s）", page, this.getPageCount());
        // assert: pages != null
    ...
    private class SpigotMeta extends BookMeta.Spigot {
        ...
        public BaseComponent[] getPage(final int page) {
            Preconditions.checkArgument(CraftMetaBookSigned.this.isValidPage(page), "页码无效");
        ...
        public void setPage(final int page, final BaseComponent... text) {
            if (!CraftMetaBookSigned.this.isValidPage(page)) {
                throw new IllegalArgumentException("页码无效：" + page + "/" + CraftMetaBookSigned.this.getPageCount());
            }
