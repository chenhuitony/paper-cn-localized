...
public class CraftMetaAxolotlBucket extends CraftMetaItem implements AxolotlBucketMeta {
    ...
    public Axolotl.Variant getVariant() {
        com.google.common.base.Preconditions.checkState(this.hasVariant(), "缺少变体，请先检查 hasVariant！");
        return Axolotl.Variant.values()[this.variant.ordinal()];
    }

    @Override
    public void setVariant(Axolotl.Variant variant) {
        com.google.common.base.Preconditions.checkArgument(variant != null, "变体不能为 null！");
