...
public class CraftMetaPotion extends CraftMetaItem implements PotionMeta {
    ...
    CraftMetaPotion(Map<String, Object> map) {
        ...
        for (Object obj : rawEffectList) {
            Preconditions.checkArgument(obj instanceof PotionEffect, "效果列表中的对象（%s）无效", obj.getClass());
    ...
    public boolean addCustomEffect(PotionEffect effect, boolean overwrite) {
        Preconditions.checkArgument(effect != null, "药水效果不能为 null");
    ...
    public boolean removeCustomEffect(PotionEffectType type) {
        Preconditions.checkArgument(type != null, "药水效果类型不能为 null");
    ...
    public void setCustomPotionName(String customName) {
        Preconditions.checkArgument(customName == null || customName.length() <= 32767, "自定义名称长度超过 32767 个字符");
