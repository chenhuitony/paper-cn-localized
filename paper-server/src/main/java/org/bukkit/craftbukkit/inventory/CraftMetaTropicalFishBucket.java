...
public class CraftMetaTropicalFishBucket extends CraftMetaItem implements TropicalFishBucketMeta {
    ...
    public DyeColor getPatternColor() {
        Preconditions.checkState(this.hasPatternColor(), "缺少图案颜色，请先检查 hasPatternColor！");
        return DyeColor.values()[this.patternColor.ordinal()];
    }

    @Override
    public void setPatternColor(DyeColor color) {
        Preconditions.checkArgument(color != null, "图案颜色不能为 null！");
        this.patternColor = net.minecraft.world.item.DyeColor.byId(color.ordinal());
    }

    @Override
    public DyeColor getBodyColor() {
        Preconditions.checkState(this.hasBodyColor(), "身体颜色不存在，请先检查 hasBodyColor！");
        return DyeColor.values()[this.baseColor.ordinal()];
    }

    @Override
    public void setBodyColor(DyeColor color) {
        Preconditions.checkArgument(color != null, "身体颜色不能为 null！");
        this.baseColor = net.minecraft.world.item.DyeColor.byId(color.ordinal());
    }

    @Override
    public TropicalFish.Pattern getPattern() {
        Preconditions.checkState(this.hasPattern(), "缺少图案，请先检查 hasPattern！");
        return TropicalFish.Pattern.values()[this.pattern.ordinal()];
    }

    @Override
    public void setPattern(TropicalFish.Pattern pattern) {
        Preconditions.checkArgument(pattern != null, "图案不能为 null！");
