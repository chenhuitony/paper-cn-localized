...
public class CraftLootTable implements org.bukkit.loot.LootTable {
    ...
    public Collection<ItemStack> populateLoot(Random random, LootContext context) {
        Preconditions.checkArgument(context != null, "战利品上下文不能为 null");
    ...
    public void fillInventory(Inventory inventory, Random random, LootContext context) {
        Preconditions.checkArgument(inventory != null, "物品栏不能为空");
        Preconditions.checkArgument(context != null, "战利品上下文不能为 null");
        LootParams nmsContext = this.convertContext(context);
    ...
    private LootParams convertContext(LootContext context) {
        ...
        Preconditions.checkArgument(loc.getWorld() != null, "LootContext.getLocation#getWorld 不能为 null");
