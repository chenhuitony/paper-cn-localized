...
public class CraftChunkSnapshot implements ChunkSnapshot {
    ...
    public boolean contains(Biome biome) {
        Preconditions.checkArgument(biome != null, "生物群系不能为 null");
    ...
    public final int getBlockSkyLight(int x, int y, int z) {
        Preconditions.checkState(this.skylight != null, "创建的 ChunkSnapshot 未包含光照数据。请以 includeLightData=true 调用 getSnapshot"); // Paper - Add getChunkSnapshot includeLightData parameter
        this.validateChunkCoordinates(x, y, z);
    ...
    public final int getBlockEmittedLight(int x, int y, int z) {
        Preconditions.checkState(this.emitLight != null, "创建的 ChunkSnapshot 未包含光照数据。请以 includeLightData=true 调用 getSnapshot"); // Paper - Add getChunkSnapshot includeLightData parameter
        this.validateChunkCoordinates(x, y, z);
    ...
    public final int getHighestBlockYAt(int x, int z) {
        Preconditions.checkState(this.heightmap != null, "创建的 ChunkSnapshot 未包含高度图。请以 includeMaxblocky=true 调用 getSnapshot");
    ...
    public final Biome getBiome(int x, int y, int z) {
        Preconditions.checkState(this.biome != null, "创建的 ChunkSnapshot 未包含生物群系。请以 includeBiome=true 调用 getSnapshot");
        this.validateChunkCoordinates(x, y, z);
