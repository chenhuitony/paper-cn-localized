    ...
    public static <T> int getDataValue(Effect effect, T data, RegistryAccess registryAccess) {
        ...
        switch (effect) {
            ...
            case INSTANT_POTION_BREAK:
                ...
                Preconditions.checkArgument(color.getAlpha() == 0xFF, "不支持 Alpha 通道");
            ...
            case RECORD_PLAY:
                ...
                if (data instanceof Material material) {
                    ...
                    Preconditions.checkArgument(item != null && item.hasDefaultData(DataComponentTypes.JUKEBOX_PLAYABLE), "材料 %s 不是音乐唱片", data);
            ...
            case WHITE_SMOKE_SHOOT:
                ...
                Preconditions.checkArgument(face.isCartesian(), face + " 不是笛卡尔方向");
            ...
            case SMOKE_SHOOT:
                switch ((BlockFace) data) {
                    ...
                    case EAST:
                        ...
                        break;
                    default:
                        throw new IllegalArgumentException("错误的烟雾方向！");
                }
                break;
            case STEP_SOUND:
                if (data instanceof Material) {
                    Preconditions.checkArgument(((Material) data).isBlock(), "材料 %s 不是方块！", data);
                ...
                if (data == null) {
                    ...
                    switch ((Axis) data) {
                        ...
                        case Z:
                            ...
                            break;
                        default:
                            throw new IllegalArgumentException("错误的电火花轴向！");
                    }
                }
                break;
            default:
