...
public class CraftBlockProjectileSource implements BlockProjectileSource {
    ...
    public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity, Consumer<? super T> function) {
        Preconditions.checkArgument(this.getBlock().getType() == Material.DISPENSER, "方块已不再是发射器");
        ...
        Preconditions.checkArgument(item instanceof ProjectileItem, "不支持抛射物 '%s'", projectile.getSimpleName());
