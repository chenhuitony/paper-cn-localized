...
public class SpigotWorldConfig {
    ...
    public void init() {
        ...
        if (SpigotConfig.version <= 12) {
            ...
            if (section != null) {
                ...
                Bukkit.getLogger().info("注意：已迁移 spigot 世界配置 %s -> %s".formatted(this.legacyWorldName, this.worldName));
            }
        }

        this.log("-------- 世界设置【" + this.worldName + "] --------");
    ...
    private int getAndValidateGrowth(String crop) {
        ...
        if (modifier == 0) {
            this.log("无法将 " + crop + " 生长设为 0，将默认使用 100");
            modifier = 100;
        }
        this.log(crop + " 生长修正: " + modifier + "%");
    ...
    private void itemMerge() {
        ...
        this.log("物品合并半径：" + this.itemMerge);
    }

    public double expMerge;
    private void expMerge() {
        this.expMerge = this.getDouble("merge-radius.exp", -1);
        this.log("经验球合并半径：" + this.expMerge);
    }
    ...
    private void simulationDistance() {
        ...
        this.log("模拟距离：" + this.simulationDistance);
    }

    public byte mobSpawnRange;
    private void mobSpawnRange() {
        this.mobSpawnRange = (byte) getInt("mob-spawn-range", 8); // Paper - Vanilla
        this.log("生物生成范围：" + this.mobSpawnRange);
    }

    public int itemDespawnRate;
    private void itemDespawnRate() {
        this.itemDespawnRate = this.getInt("item-despawn-rate", 6000);
        this.log("物品消失速率：" + this.itemDespawnRate);
    }
    ...
    private void activationRange() {
        ...
        this.log("实体激活范围：动物 " + this.animalActivationRange + " / Mo " + this.monsterActivationRange + " / Ra " + this.raiderActivationRange + " / Mi " + this.miscActivationRange + " / Tiv " + this.tickInactiveVillagers + " / Isa " + this.ignoreSpectatorActivation);
    }
    ...
    private void trackingRange() {
        ...
        this.log("实体跟踪范围：玩家 " + this.playerTrackingRange + " / An " + this.animalTrackingRange + " / Mo " + this.monsterTrackingRange + " / Mi " + this.miscTrackingRange + " / Di " + this.displayTrackingRange + " / Other " + this.otherTrackingRange);
    }
    ...
    private void hoppers() {
        ...
        this.log("漏斗转移：" + this.hopperTransfer + " 漏斗检查间隔: " + this.hopperCheck + " 漏斗单次传输量: " + this.hopperAmount + " 漏斗可加载区块: " + this.hopperCanLoadChunks);
    }
    ...
    private void initWorldGenSeeds() {
        ...
        this.log("自定义地图种子： 村庄：" + this.villageSeed + " Desert: " + this.desertSeed + " Igloo: " + this.iglooSeed + " Jungle: " + this.jungleSeed + " Swamp: " + this.swampSeed + " Monument: " + this.monumentSeed
            + " Ocean: " + this.oceanSeed + " Shipwreck: " + this.shipwreckSeed + " 末地城: " + this.endCitySeed + " Slime: " + this.slimeSeed + " Nether: " + this.netherSeed + " Mansion: " + this.mansionSeed + " Fossil: " + this.fossilSeed + " Portal: " + this.portalSeed);
    }
    ...
    private void maxTntPerTick() {
        ...
        this.log("每刻最大 TNT 爆炸数：" + this.maxTntTicksPerTick);
    }
    ...
    private void maxTickTimes() {
        ...
        this.log("方块实体最大 Tick 时间：" + this.tileMaxTickTime + "ms 实体最大 Tick 时间：" + this.entityMaxTickTime + "ms");
    }
