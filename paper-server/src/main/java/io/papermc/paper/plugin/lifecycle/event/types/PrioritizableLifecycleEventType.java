...
> extends AbstractLifecycleEventType<O, E, C> {
    ...
    protected void register(final O owner, final AbstractLifecycleEventHandlerConfiguration<O, E> config) {
        Preconditions.checkArgument(config instanceof PrioritizedLifecycleEventHandlerConfigurationImpl<?, ?>, "Configuration 必须是 PrioritizedLifecycleEventHandlerConfiguration 类型");
