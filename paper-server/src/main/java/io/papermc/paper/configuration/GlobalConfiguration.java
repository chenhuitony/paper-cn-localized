...
public class GlobalConfiguration extends ConfigurationPart {
    ...
    public class Messages extends ConfigurationPart {
        ...
        public class Kick extends ConfigurationPart {
            ...
            public Component connectionThrottle = Component.text("连接被限制！请稍后再试。");
        ...
        public Component noPermission = Component.text("抱歉，你没有权限执行此命令。如果你认为这是错误的，请联系服务器管理员。", NamedTextColor.RED);
