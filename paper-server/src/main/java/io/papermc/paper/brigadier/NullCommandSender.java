...
public final class NullCommandSender implements CommandSender {
    ...
    public Server getServer() {
        ...
        if (server == null) {
            throw new UnsupportedOperationException("服务端尚未创建，此时无法从 'null' CommandSender 访问它");
        }
        return server;
    }
    ...
    public PermissionAttachment addAttachment(final Plugin plugin, final String name, final boolean value) {
        throw new UnsupportedOperationException("无法向 'null' CommandSender 添加附件");
    }
    ...
    public Set<PermissionAttachmentInfo> getEffectivePermissions() {
        throw new UnsupportedOperationException("无法从 'null' 命令发送者移除附件");
    }
