        ...
        when(instance.getTag(any(), any(), any())).then(mock -> {
            ...
            switch (registry) {
                ...
                case org.bukkit.Tag.REGISTRY_ITEMS -> {
                    Preconditions.checkArgument(clazz == Material.class, "物品命名空间必须包含物品类型");
                ...
                case org.bukkit.Tag.REGISTRY_FLUIDS -> {
                    Preconditions.checkArgument(clazz == org.bukkit.Fluid.class, "流体命名空间必须包含流体类型");
                ...
                case org.bukkit.Tag.REGISTRY_ENTITY_TYPES -> {
                    Preconditions.checkArgument(clazz == org.bukkit.entity.EntityType.class, "实体类型命名空间必须包含实体类型");
                ...
                case org.bukkit.Tag.REGISTRY_GAME_EVENTS -> {
                    Preconditions.checkArgument(clazz == org.bukkit.GameEvent.class, "游戏事件命名空间必须包含游戏事件");
